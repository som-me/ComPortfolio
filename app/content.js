...
//Contact
//
export const ConHead = "Struggling to build a brand to reach your audience?";
export const ConCTA = "BOOK A CALL";
export const Title = "Som Meher";
export const TitleCTA = "Discovery Call (15 Minutes)";
export const ConDesc = "No more guessing games — let’s build a brand that truly reflects you. We’ll hop on a quick 15-minute call to talk about your business, your goals, and what’s holding you back. By the end, you’ll know exactly where we stand and what comes next.";
export const Time = "15 m";
